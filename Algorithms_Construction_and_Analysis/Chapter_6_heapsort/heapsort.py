...
class HeapSort:
    ...
    def sort(self) -> List[int]:
        ...
        O(n) - для каждого индекса, кроме 0; * O(log(n)) - приведение пирамиды к невозрастаюему виду = O(n * log(n)).
        """
        ...
        Первый параметр = длина - 1, поскольку нам нужен максимаьный индекс.
    ...
    def _build_heap(self) -> None:
        ...
        Поскольку последний родитель назодится в середине массива (n//2), то с него можно начать построение пирамиды.
