"""
Bubble Sort или же карманная сортировка хорошая для относительно равномерно распределенных входных данных.
...
class BucketSort:
    ...
    def sort(self) -> List[float]:
        ...
        карманам для оптимальной скорорости работы алгоритма
        """
        ...
        Переписываем каждый элемент входного массива отсортированны элементом из временного массива с карманами в
