"""
Hash-таблица, в которой используется двойное хэширование.
...
попадают в один хэшированный индекс, то происходит вторичное хэширование и они распределяются по разным ячейкам
внутреннего массива.
"""
